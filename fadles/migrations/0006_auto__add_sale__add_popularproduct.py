...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sale'
        db.create_table(u'fadles_sale', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('preview', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sales', to=orm['fadles.Product'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'fadles', ['Sale'])

        # Adding model 'PopularProduct'
        db.create_table(u'fadles_popularproduct', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('start_price', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('unit', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('preview', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='populars', to=orm['fadles.Product'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'fadles', ['PopularProduct'])


    def backwards(self, orm):
        # Deleting model 'Sale'
        db.delete_table(u'fadles_sale')

        # Deleting model 'PopularProduct'
        db.delete_table(u'fadles_popularproduct')
